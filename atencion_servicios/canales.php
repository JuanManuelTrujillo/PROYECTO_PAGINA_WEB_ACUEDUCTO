...
<html lang="es">
 ...
 <div class="container-fluid page-header py-5">
            <div class="container text-center py-5">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Canales de Atención</h1>
    ...
    <div class=" col-sm-3">
     ...
     <div class="blog-content text-center position-relative px-3" style="margin-top: ">
       ...
       <details style="font-size:15px ">
        <summary 
         class="blog-coment d-flex justify-content-between px-4 py-2 border bg-primary rounded-bottom" style="margin-top: -1px; "> </sumary>

            <p >
            <h7 class="text-white bg-primary rounded" >
