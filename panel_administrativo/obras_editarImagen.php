...
{
	$id = $_GET['edit_id'];
	$stmt_edit = $DB_con->prepare('SELECT Imagen_Marca,  Imagen_Img FROM obras WHERE Imagen_ID =:uid');
...
{
	header("Location: obras_acueducto.php");
}	
...
if(isset($_POST['btn_save_updates']))
{
	...
	if(!isset($errMSG))
	{
		$stmt = $DB_con->prepare('UPDATE obras 
...
<script>
			...
			window.location.href='obras_acueducto.php';
			</script>
<?php
		}
		else{
...
<div class="container">
  <div class="page-header">
    <h1 class="h2">Actualización producto. <a class="btn btn-default" href="obras_acueducto.php"> Mostrar todos los modelos </a></h1>
  </div>
  ...
  <form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <table class="table table-bordered table-responsive">
      ...
      <tr>
        ...
        <td><p><img src="imagenes1/<?php echo $Imagen_Img; ?>" height="150" width="150" /></p>
